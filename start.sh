...
cp ${MIRANTIS_IMAGE_NAME} fuel.iso
...
virsh net-undefine network_admin
virsh net-define network_admin
virsh net-autostart network_admin
virsh net-start network_admin

virsh net-destroy network_public
virsh net-undefine network_public
virsh net-define network_public
virsh net-autostart network_public
virsh net-start network_public

virsh net-destroy network_private
virsh net-undefine network_private
virsh net-define network_private
virsh net-autostart network_private
virsh net-start network_private

virsh net-destroy network_storage
virsh net-undefine network_storage
virsh net-define network_storage
virsh net-autostart network_storage
virsh net-start network_storage

virsh net-destroy network_mgmt
virsh net-undefine network_mgmt
virsh net-define network_mgmt
virsh net-autostart network_mgmt
virsh net-start network_mgmt




virt-install --connect qemu:///system --noautoconsole --filesystem ${PWD},shared_dir --import --name fuel --ram 2048 --vcpus 1 --disk fuel.img,size=64 --boot hd,cdrom,network --disk fuel.iso,device=cdrom --network network=network_admin,mac="08:00:28:af:10:10" --network network=network_public,mac="08:00:28:af:10:11" --network network=network_private,mac="08:00:28:af:10:12" --network network=network_storage,mac="08:00:28:af:10:13" --network network=network_mgmt,mac="08:00:28:af:10:14" 
